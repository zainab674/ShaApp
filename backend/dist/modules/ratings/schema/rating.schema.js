...
exports.userJsonSchema = exports.RatingSchema = exports.RatingEntity = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, mongoose_1.Prop)({ type: mongoose_2.default.Schema.Types.ObjectId, ref: "BookingEntity" }),
    __metadata("design:type", String)
], RatingEntity.prototype, "bookingId", void 0);
...
const RatingSchema = mongoose_1.SchemaFactory.createForClass(RatingEntity);
